...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            // Wallpaper prev layer (crossfade out)
            Image {
                id: wallpaperPrev
                ...
                x: wallpaper.x
                y: wallpaper.y
                sourceSize: wallpaper.sourceSize
            ...
            StyledImage {
                ...
                onSourceChanged: {
                    console.log("[crossfade] sourceChanged, prev:", wallpaper.prevSource, "new:", wallpaper.source)
                    if (wallpaper.prevSource !== "") {
                        wallpaperPrev.source = wallpaper.prevSource
                        wallpaperPrev.opacity = 1
                        console.log("[crossfade] set wallpaperPrev.source =", wallpaperPrev.source, "opacity = 1")
                    }
                    wallpaper.prevSource = wallpaper.source
                }
                onStatusChanged: {
                    console.log("[crossfade] statusChanged:", status)
